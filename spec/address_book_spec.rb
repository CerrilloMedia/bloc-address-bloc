...
RSpec.describe AddressBook do
    ...
    describe "#binary_search" do #Test the binary_search method
        ...
        it "searches AddressBook for Bill" do
            ...
            expect(entry).to be_a Entry #entry for "Bill" should be of class Entry
            check_entry(entry, "Bill", "555-555-4854", "bill@blocmail.com")
        end
       
        it "searcheds AddressBook for Bob" do
            book.import_from_csv("entries.csv")
    ...
    describe "#iterative_search" do
        ...
        it "searches AddressBook for non-existent entry" do
            book.import_from_csv("entries.csv")
            entry = book.iterative_search("Mr. Blah")
            expect(entry).to be_nil
        end
        it "searches AddressBook for Bill" do
            book.import_from_csv("entries.csv")
